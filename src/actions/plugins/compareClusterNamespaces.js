...
async function compareClusterNamespaces(cluster1, k8sClient1, cluster2, k8sClient2, output) {
  const namespaces1 = await ClusterFunctions.getNamespacesForCluster(cluster1, k8sClient1)
  const namespaces2 = await ClusterFunctions.getNamespacesForCluster(cluster2, k8sClient2)
